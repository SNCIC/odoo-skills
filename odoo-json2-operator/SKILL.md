...
- Configure Odoo system connection profiles in `scripts/connections.json`, including `base_url`, `database`, and `api_key`.
...
- Store and maintain those named profiles in `scripts/connections.json`.
